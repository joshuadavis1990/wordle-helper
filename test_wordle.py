...
# The test cases have been written to ensure that the user is asked to re-enter their word if it does not meet the requirements.
...
# Test case 2 - the excpected result is "Pass" as typing "q" should present the user with the KeyboardInterrupt error and quit the program
def test_word_entered(monkeypatch):
